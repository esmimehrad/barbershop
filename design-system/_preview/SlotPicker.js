...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/SlotPicker.tsx
  var SlotPicker_exports = {};
  __export(SlotPicker_exports, {
    RankedTwoChoice: () => RankedTwoChoice,
  ...
  var SingleChoice = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SlotPicker,
    {
      dates: DATES,
      selectedDateId: "wed",
      onSelectDate: () => {
  ...
  var RankedTwoChoice = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SlotPicker,
    {
      dates: DATES,
      selectedDateId: "wed",
  ...
  return __toCommonJS(SlotPicker_exports);
})();
